...
PICS = (environ.get('PICS', 'https://telegra.ph/file/cced0eeee96fec8ed0d98.jpg')).split() #SAMPLE PIC
...
auth_channel = environ.get('AUTH_CHANNEL','-1002085230546')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', 'https://t.me/Ownersupport')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://bihiga1628:WEiOnRZblHuhJalO@cluster0.gbqqv.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "bihiga1628")
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/HOWTO615/8')
